...
[[https://github.com/quelpa/quelpa][quelpa]] allows building and installing packages directly from source - useful for packages not in registries.
...
#+begin_src emacs-lisp
  ...
  (use-package lsp-mode
    ...
    ;; (setq lsp-eslint-server-command '("node" "/Users/will/apps/vscode-eslint/server/out/eslintServer.js" "--stdio"))
...
*** Install =emacs-prisma-mode=

[[https://github.com/pimeys/emacs-prisma-modelink][emacs-prisma-mode]] is a nice little major mode for editing [[https://www.prisma.io/][Prisma]] schemas.
