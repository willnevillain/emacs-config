...
- ripgrep
- preferable: project local installations of eslint for JS / TS projects
- preferable: project local installations of prettier for JS / TS projects
...
#+begin_src emacs-lisp
  ...
  (defun setup-tide-mode ()
    ...
    (setq flycheck-check-syntax-automatically
          '(save idle-change mode-enabled new-line)) ;; Configure aggressive syntax checking cadence
...
#+begin_src emacs-lisp
  (defun wneville/goto-configuraion ()
    (interactive)
