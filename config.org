...
#+begin_src emacs-lisp :results output silent
  ...
  (use-package lsp-mode
    ...
    :config
    (add-to-list 'lsp-disabled-clients '(prisma-mode . eslint))
    (setq lsp-eslint-server-command '("node" "/Users/will/apps/vscode-eslint-release-2.1.25/server/out/eslintServer.js" "--stdio"))
