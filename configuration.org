...
Ivy completion - the minibuff is best buff.
#+BEGIN_SRC emacs-lisp
  (use-package ivy
    :diminish)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  (global-set-key (kbd "C-h v") 'counsel-describe-function)
  ...
  (global-set-key (kbd "C-c C-f") 'counsel-org-file)
#+END_SRC
...
Love me some projectile. Use ivy as our completion engine (when we're not delegating to =counsel-projectile=)
#+BEGIN_SRC emacs-lisp
...
Counsel-projectile to get all that ivy goodness.
#+BEGIN_SRC emacs-lisp
