...
#+END_SRC
** Presentation modes
Epresent is a presentation mode for org-mode
#+BEGIN_SRC emacs-lisp
(use-package epresent)
#+END_SRC

Also trying out org-present
#+BEGIN_SRC emacs-lisp
...
(use-package elpy
  ...
  (elpy-enable))
#+END_SRC
I only use Company with elpy right now, so some quality of life fixes here.
Reduce delay to show, minimum prefix when to show suggestions, wrap around to top of list at bottom, and allow tab to cycle through suggestions.
#+BEGIN_SRC emacs-lisp
